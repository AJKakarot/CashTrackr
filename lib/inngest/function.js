...
async function generateFinancialInsights(stats, month) {
  ...
  // Prepare financial data in structured format
  const financialData = {
    monthlyIncome: stats.totalIncome,
    expenseTransactions: Object.entries(stats.byCategory).map(([category, amount]) => ({
      category,
      amount,
    })),
    monthlyBudgets: null, // Can be extended if category budgets exist
  };
...
User question:
"Analyze my spending for ${month} and provide 3 key insights"
